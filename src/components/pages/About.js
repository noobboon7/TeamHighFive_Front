          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-4">
              <div class="card border-0 mb-5">
                ...
                <div class="card-body">
                  <h6 class="card-subtitle mb-2 intro-lead">Project Manager</h6>
                  <h3 class="card-title">William Golden</h3>
                  <p class="card-text">I am a software engineer from Tuscaloosa Alabama currently working in the NYC area. In college I used my web dev talents to give local companies in the Tuscaloosa area a web presence and afterward enjoyed a brief stint as a professional poker player. After a couple of years I re-engaged with my original passion of web development and enrolled at Fullstack Academy of Code to further my skills into being a fullstack software engineer. I am currently working at Blackbird LLC as a software engineer creating user interfaces for hedge fund traders and investors.</p>
                </div>
            ...
            <div className="col-lg-4">
              <div class="card border-0 mb-5">
                ...
                <div class="card-body">
                  <h6 class="card-subtitle mb-2 intro-lead">UX/UI Designer</h6>
                  <h3 class="card-title">Kellie Porter</h3>
                  <p class="card-text">As a native New Yorker, I have a fast-paced creative mind to match the city I call home. I have worked to put my energy into my passions which include Graphic Communications, Web Development, Digital Literacy, STEM education, and UX/UI design</p>
                </div>
                <div class="card-footer social-media border-0">
                <ul className="list-inline m-0 text-uppercase text-center">
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-3">
              <div class="card border-0 mb-5">
                <img className="card-img-top w-100 h-100" src={Katie} alt="Katharine Francis"></img>
                  <div class="card-body">
                    <h6 class="card-subtitle mb-2 intro-lead">Software Developer / Tech Lead</h6>
                    <h3 class="card-title">Katharine Francis</h3>
                    <p class="card-text">I'm a software developer with a familiarity of Javascript technologies, such as React/Redux, React Native, Node.js/Express and Electron. I'm also passionate about designing dynamic websites with the latest CSS3 features.</p>
                  </div>
                  <div class="card-footer social-media border-0">
                  <ul className="list-inline m-0 text-uppercase text-center">
            ...
            <div className="col-lg-3">
              <div class="card border-0 mb-5">
                ...
                <div class="card-body">
                  <h6 class="card-subtitle mb-2 intro-lead">Full Stack Web Developer</h6>
                  <h3 class="card-title">Jerry Velazquez</h3>
                  <p class="card-text">I'm a software developer with about 1 year experience and actively seeking a Full-time opportunity to work as a full-stack developer.</p>
                </div>
                <div class="card-footer social-media border-0">
                <ul className="list-inline m-0 text-uppercase text-center">
            ...
            <div className="col-lg-3">
              <div class="card border-0 mb-5">
                ...
                <div class="card-body">
                  <h6 class="card-subtitle mb-2 intro-lead">Full Stack Web Developer</h6>
                  <h3 class="card-title">Parker Bacall</h3>
            ...
            <div className="col-lg-3">
              <div class="card border-0 mb-5">
                ...
                <div class="card-body">
                  <h6 class="card-subtitle mb-2 intro-lead">Software Developer</h6>
                  <h3 class="card-title">Jo Chen</h3>
                  <p class="card-text">I am a full-stack engineer with experience in JavaScript, Ruby, React, Redux, Rails, Express, MongoDB, SQL, Mongoose, Amazon Web Services, HTML5, CSS3, PostgreSQL, AJAX, the Spoonacular API, and the Google Maps API.</p>
                </div>
                <div class="card-footer social-media border-0">
                <ul className="list-inline m-0 text-uppercase text-center">
            ...
            <div className="col-lg-3">
              <div class="card border-0 mb-5">
                ...
                <div class="card-body">
                  <h6 class="card-subtitle mb-2 intro-lead">Software Developer</h6>
                  <h3 class="card-title">Cihad Aldanmaz</h3>
                  <p class="card-text">Software Developer with a passion for creativity and utilizing technology to problem solve for businesses. With experience in Ruby on Rails, JavaScript, and React and a background in Communication and Marketing, I would love to help design efficient code for business products.</p>
                </div>
                <div class="card-footer social-media border-0">
                <ul className="list-inline m-0 text-uppercase text-center">
